...
public class SentSimpleMail {
    ...
    private static final String FROM = "81315507@qq.com"; // 发件人邮箱地址
    ...
    public void sentSimpleMail(String subject, String text, String toRecipients)
        ...
        // 简单发送邮件的方式
        Transport.send(message, FROM, "szenwdrpxsrhbjcf"); // 授权码
    }

//    public static void main(String[] args) throws AddressException, MessagingException {
//        new SentSimpleMail().sentSimpleMail("找回密码", "8150", "81315507@qq.com");
//    }
}
